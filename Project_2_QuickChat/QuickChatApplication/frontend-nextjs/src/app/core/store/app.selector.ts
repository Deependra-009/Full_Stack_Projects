...
export const getSelectedGroup=createSelector(getAppSelector,(state:fromAppState.AppState)=>state.selectedGroup);
...
export const getCreateGroupStatus=createSelector(getAppSelector,(state:fromAppState.AppState)=>state.isCreateGroup);

export const getGroupList=createSelector(getAppSelector,(state:fromAppState.AppState)=>state.groupsData);
