...
export const setSelectedGroup=(dispatch:any,conversationResponse:GroupEntity)=>{
    dispatch(fromAppActions.setSelectedGroup(conversationResponse))
}
...
export const createGroupStatus=(dispatch:any,value:boolean)=>{
    dispatch(fromAppActions.createGroupStatusChange(value));
}

export const createGroup=(dispatch:any,value:GroupEntity)=>{
    dispatch(fromAppActions.createGroup(value));
}

export const updateGroupMessage=(dispatch:any,value:MessageResponse)=>{
    dispatch(fromAppActions.updateGroupMessage(value));
}

export const closeAllChats=(dispatch:any)=>{
    dispatch(fromAppActions.closeAllChats());
}