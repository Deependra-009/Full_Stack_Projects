...
import { MenData } from "./../../Core/Constant_Data/MenData";
    ...
    <>
      <div class="w-[100%]">
        ...
        <ProductCardDepartmentPage
          heading={MenData.data1.heading}
          subHeading={MenData.data1.subheading}
          ProductData={MenData.data1.product}
        />
        <ProductCardDepartmentPage
          heading={MenData.data2.heading}
          subHeading={MenData.data2.subheading}
          ProductData={MenData.data2.product}
        />
        <ProductCardDepartmentPage
          heading={MenData.data3.heading}
          subHeading={MenData.data3.subheading}
          ProductData={MenData.data3.product}
        />
      </div>
    </>
  );
