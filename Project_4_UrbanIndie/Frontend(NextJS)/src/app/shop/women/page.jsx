"use client";
import { WomenData } from "../../Core/Constant_Data/WomenData";
    ...
    <>
      <div class="w-[100%]">
        ...
        <ProductCardDepartmentPage
          heading={WomenData.data1.heading}
          subHeading={WomenData.data1.subheading}
          ProductData={WomenData.data1.product}
        />
        <ProductCardDepartmentPage
          heading={WomenData.data2.heading}
          subHeading={WomenData.data2.subheading}
          ProductData={WomenData.data2.product}
        />
        <ProductCardDepartmentPage
          heading={WomenData.data3.heading}
          subHeading={WomenData.data3.subheading}
          ProductData={WomenData.data3.product}
        />
      </div>
    </>
  );
